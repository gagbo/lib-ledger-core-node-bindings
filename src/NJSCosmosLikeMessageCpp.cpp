...
NAN_METHOD(NJSCosmosLikeMessage::wrapMsgSubmitProposal) {
    ...
    auto field_arg_0_1_3 = Nan::Get(field_arg_0_1->ToObject(Nan::GetCurrentContext()).ToLocalChecked(), Nan::New<String>("description").ToLocalChecked()).ToLocalChecked();
...
NAN_METHOD(NJSCosmosLikeMessage::unwrapMsgSubmitProposal) {
    ...
    auto arg_1_1_3 = Nan::New<String>(result.content.description).ToLocalChecked();
    Nan::DefineOwnProperty(arg_1_1, Nan::New<String>("description").ToLocalChecked(), arg_1_1_3);
...
NAN_METHOD(NJSCosmosLikeMessage::wrapMsgCreateValidator) {
    ...
    auto field_arg_0_1 = Nan::Get(info[0]->ToObject(Nan::GetCurrentContext()).ToLocalChecked(), Nan::New<String>("description").ToLocalChecked()).ToLocalChecked();
...
NAN_METHOD(NJSCosmosLikeMessage::unwrapMsgCreateValidator) {
    ...
    auto arg_1 = Nan::New<Object>();
    auto arg_1_1 = Nan::New<Object>();
    auto arg_1_1_1 = Nan::New<String>(result.description.moniker).ToLocalChecked();
    ...
    {
        auto arg_1_1_2_optional = (result.description.identity).value();
    ...
    {
        auto arg_1_1_3_optional = (result.description.website).value();
    ...
    {
        auto arg_1_1_4_optional = (result.description.details).value();
    ...
    Nan::DefineOwnProperty(arg_1, Nan::New<String>("description").ToLocalChecked(), arg_1_1);
...
NAN_METHOD(NJSCosmosLikeMessage::unwrapMsgEditValidator) {
    ...
    {
        auto arg_1_1_optional = (result.description).value();
